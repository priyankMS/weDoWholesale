  ...
  return (
    <div className="p-6">
      <div className="mb-5">
        ...
        <p className="text-[0.82rem] text-neutral-500">{total} orders</p>
      </div>
      ...
      <div className="mb-4 flex flex-wrap gap-1.5">
        ...
        {STATUSES.map((s) => (
          <Link
            key={s}
            href={statusHref(s)}
            className={`rounded-lg px-3 py-1.5 text-[0.78rem] font-bold capitalize ${
          ...
          <tbody>
            {orders.map((o) => (
              <tr key={o.id} className="border-b border-neutral-100 last:border-0 hover:bg-neutral-50">
                <td className="px-4 py-2.5 font-mono text-[0.78rem] font-semibold text-neutral-900">
                  #{o.orderNumber}
                </td>
